...
<h2>Daftar siswa kelas
    <span class="badge badge-secondary mb-3">Dua</span>
            </h2>
    ...
    <table class="table table-borderless table-striped table-earning">
        ...
        <tbody>
            ...
            <tr>
                ...
                <form action="{{route('siswakelas2.destroy', $item->id)}}" method="post" class="d-inline" class="d-inline" onclick="return confirm('Yakin mau dihapus?')">
                    @csrf
                    @method('delete')
